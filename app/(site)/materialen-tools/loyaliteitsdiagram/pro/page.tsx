...
export const metadata: Metadata = {
  title: "Loyaliteitsdiagram – Pro – Stiefkompas",
  description:
    "De pro-variant van het Loyaliteitsdiagram is beschikbaar via het Stiefkompas-portaal voor gecertificeerde professionals met licentie.",
};

export default function LoyaliteitsdiagramProPage() {
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-4 border-b border-slate-200 pb-8">
        ...
        <p className="text-sm md:text-base text-slate-700 max-w-3xl leading-relaxed">
          ...
          Je krijgt toegang tot formats, begeleiderskaders en interventies via het Stiefkompas-portaal.
        </p>
      ...
      <section className="grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-4">
          ...
          <ul className="list-disc pl-5 text-sm md:text-base text-slate-700 leading-relaxed space-y-2">
            <li>Printbare diagramformats (download) voor sessies en huiswerk.</li>
            <li>Begeleidershandleiding: opbouw, tempo, veiligheid en valkuilen.</li>
            <li>Herkenningskaders: klem-signalen en typische escalatiepatronen.</li>
            <li>Interventies voor erkenning, ontlasting en het normaliseren van loyaliteit.</li>
            <li>Koppeling naar Rollen, Grenzen en Communicatie + Stiefkompas Plan.</li>
          </ul>
      ...
      {/* Gate */}
      <ProGate
        title="Loyaliteitsdiagram – Pro materialen"
        teaser="In het portaal vind je de diagramformats (download/print), begeleiderskaders, interventies en verdiepende werkbladen. Alleen beschikbaar voor gecertificeerde professionals met licentie."
      />
    </div>
  );
}
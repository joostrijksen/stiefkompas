...
export const metadata: Metadata = {
  title: "Rollenkaart – Pro – Stiefkompas",
  description:
    "De pro-variant van de Rollenkaart is beschikbaar via het Stiefkompas-portaal voor gecertificeerde professionals met licentie.",
};

export default function RollenkaartProPage() {
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-4 border-b border-slate-200 pb-8">
        ...
        <p className="text-sm md:text-base text-slate-700 max-w-3xl leading-relaxed">
          ...
          Je krijgt toegang tot de volledige Rollenkaart, begeleidershandleiding en verdiepende
          formats via het Stiefkompas-portaal.
        </p>
      ...
      {/* Wat zit er in Pro (preview zonder details) */}
      <section className="grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-4">
          ...
          <ul className="list-disc pl-5 text-sm md:text-base text-slate-700 leading-relaxed space-y-2">
            <li>
              De volledige Rollenkaart (print/download) voor gebruik in sessies en huiswerk.
            </li>
            <li>
              Begeleidershandleiding: opbouw, volgorde, valkuilen en veilige formuleringen.
            </li>
            <li>
              Verdiepende formats om rolverwachtingen te concretiseren in afspraken.
            </li>
            <li>
              Voorbeeldroutes: hoe je Rollen koppelt aan Grenzen, Loyaliteit en Communicatie.
            </li>
            <li>
              Koppeling naar het Stiefkompas Plan (routeboek) voor borging en evaluatie.
            </li>
          </ul>
      ...
      {/* Gate (alleen pro content achter licentie/certificering) */}
      <ProGate
        title="Rollenkaart – Pro materialen"
        teaser="In het portaal vind je de volledige Rollenkaart (download/print), begeleidershandleiding, formats en verdiepende werkbladen. Alleen beschikbaar voor gecertificeerde professionals met licentie."
      />
    </div>
  );
}
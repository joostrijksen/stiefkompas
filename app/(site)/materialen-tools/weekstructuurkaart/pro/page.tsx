...
export const metadata: Metadata = {
  title: "Weekstructuurkaart – Pro – Stiefkompas",
  description:
    "De pro-variant van de Weekstructuurkaart is beschikbaar via het Stiefkompas-portaal voor gecertificeerde professionals met licentie.",
};

export default function WeekstructuurkaartProPage() {
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-4 border-b border-slate-200 pb-8">
        ...
        <p className="text-sm md:text-base text-slate-700 max-w-3xl leading-relaxed">
          ...
          Je krijgt toegang tot formats, begeleiderskaders en voorbeeldstructuren via het portaal.
        </p>
      ...
      <section className="grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-4">
          ...
          <ul className="list-disc pl-5 text-sm md:text-base text-slate-700 leading-relaxed space-y-2">
            <li>Printbare weekformats (download) voor sessies en huiswerk.</li>
            <li>Begeleidershandleiding: opbouw, tempo, focus en valkuilen.</li>
            <li>Voorbeeldstructuren voor wisselritmes, routines en overgangsmomenten.</li>
            <li>Interventies voor overgangsstress en het vergroten van voorspelbaarheid.</li>
            <li>Koppeling naar Grenzen, Communicatie en Stiefkompas Plan.</li>
          </ul>
      ...
      {/* Gate */}
      <ProGate
        title="Weekstructuurkaart – Pro materialen"
        teaser="In het portaal vind je de weekformats (download/print), begeleidershandleiding, voorbeeldstructuren en verdiepende werkbladen. Alleen beschikbaar voor gecertificeerde professionals met licentie."
      />
    </div>
  );
}
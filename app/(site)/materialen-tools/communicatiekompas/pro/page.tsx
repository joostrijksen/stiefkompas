...
export const metadata: Metadata = {
  title: "Communicatiekompas – Pro – Stiefkompas",
  description:
    "De pro-variant van het Communicatiekompas is beschikbaar via het Stiefkompas-portaal voor gecertificeerde professionals met licentie.",
};

export default function CommunicatiekompasProPage() {
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-4 border-b border-slate-200 pb-8">
        ...
        <p className="text-sm md:text-base text-slate-700 max-w-3xl leading-relaxed">
          ...
          Je krijgt toegang tot analysemodellen, begeleiderskaders en interventies via het portaal.
        </p>
      ...
      <section className="grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-4">
          ...
          <ul className="list-disc pl-5 text-sm md:text-base text-slate-700 leading-relaxed space-y-2">
            <li>Analysemodellen voor communicatiepatronen en escalatie.</li>
            <li>Begeleidershandleiding: timing, interventiekeuzes en valkuilen.</li>
            <li>Interventies voor vertraging, herstel en herformulering.</li>
            <li>Voorbeeldvragen en veilige formuleringen.</li>
            <li>Koppeling naar Rollen, Grenzen, Loyaliteit en Stiefkompas Plan.</li>
          </ul>
      ...
      {/* Gate */}
      <ProGate
        title="Communicatiekompas – Pro materialen"
        teaser="In het portaal vind je analysemodellen, begeleiderskaders, interventies en verdiepende werkbladen. Alleen beschikbaar voor gecertificeerde professionals met licentie."
      />
    </div>
  );
}
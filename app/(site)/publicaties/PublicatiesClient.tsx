      ...
      <div className="space-y-14">
        ...
        <section className="space-y-5 border-b border-slate-200 pb-10">
          ...
          <p className="text-sm md:text-base text-slate-700 max-w-3xl leading-relaxed">
            Deze kennisbank bevat artikelen, whitepapers en onderzoekssamenvattingen die de methodische
            onderbouwing van Stiefkompas toelichten. Thema’s zijn onder andere systeemtheorie, hechting,
            loyaliteit, communicatie en stressregulatie binnen samengestelde gezinnen.
          </p>

          <p className="text-sm text-slate-600 max-w-3xl leading-relaxed">
            Nieuwe publicaties verschijnen de komende periode. Gecertificeerde professionals krijgen daarnaast
            toegang tot verdiepende documenten, praktijkvoorbeelden en literatuurverwijzingen.
          </p>
          ...
          <p className="text-xs text-slate-500">
            {filtered.length} publicatie{filtered.length === 1 ? "" : "s"} in {activeFilter.toLowerCase()}
          </p>
        </section>

        {/* Artikelen grid */}
        <section className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 items-stretch">
          {filtered.map((a, idx) => {
            ...
            return (
              ...
              >
                ...
                <p className={["mt-4 text-xs font-semibold uppercase tracking-[0.18em]", statusColor].join(" ")}>
                  {a.status}
                </p>

                {/* Actie altijd onderin */}
        ...
        <section className="border-t border-slate-200 pt-10">
          <div className="space-y-4 max-w-3xl">
            ...
            <p className="text-sm md:text-base text-slate-700 leading-relaxed">
              Stiefkompas sluit aan bij inzichten uit systeemtheorie, hechtingsonderzoek en literatuur over
              scheiding en gezinsdynamiek. In verdiepende documenten voor professionals werken we met
              literatuurlijsten en verwijzingen per thema.
            </p>
        ...
        <section className="border-t border-slate-200 pt-10">
          <div className="space-y-4 max-w-3xl">
            ...
            <p className="text-sm md:text-base text-slate-700 leading-relaxed">
              Tijdens de training leren deelnemers werken met het Kompasmodel en ontvangen zij aanvullende literatuur,
              casusmateriaal en tools die niet publiekelijk beschikbaar zijn.
            </p>

...
export default function MethodePage() {
  ...
  const tocItems = [
    { id: "stiefgezin-specifiek", label: "Wat maakt samengestelde gezinnen anders?", icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" },
    { id: "hoe-werkt-het", label: "Hoe werk je met het Kompasmodel?", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
    { id: "pijlers", label: "De vijf pijlers van het Kompasmodel", icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" },
    { id: "onderbouwing", label: "Onderbouwing & bronnen", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
    { id: "wat-niet", label: "Wat Stiefkompas bewust niet is", icon: "M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" },
    { id: "voor-wie", label: "Voor wie is deze methodiek bedoeld?", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
    { id: "training", label: "Wat je in de training krijgt", icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" },
  ];
  ...
  return (
    <div className="relative bg-white">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-20 space-y-16">
        ...
        {/* INHOUDSOPGAVE */}
        <section className="relative overflow-hidden rounded-3xl border border-[#17B3B0]/20 bg-gradient-to-br from-[#17B3B0]/5 via-white to-white p-8 lg:p-10 shadow-md">
          <div className="absolute left-0 top-0 h-full w-2 bg-[#17B3B0]" />
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl lg:text-3xl font-semibold tracking-tight text-[#0E2A47]">
                Inhoudsopgave
              </h2>
            </div>
            <svg 
              className={`h-6 w-6 text-[#2C4B9A] transition-transform ${tocOpen ? 'rotate-180' : ''}`}
              fill="none" 
              viewBox="0 0 24 24" 
              stroke="currentColor"
            >
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {tocItems.map((item, index) => (
                <button
                  ...
                  className="group flex items-start gap-3 rounded-2xl border border-slate-200 bg-white p-4 text-left transition-all hover:border-[#17B3B0]/40 hover:shadow-md"
                >
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#17B3B0]/10 text-[#17B3B0] transition-colors group-hover:bg-[#17B3B0] group-hover:text-white">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-xs font-semibold text-[#2C4B9A]">
                        {(index + 1).toString().padStart(2, '0')}
                      </span>
                    </div>
                    <p className="text-sm font-medium text-slate-700 leading-snug group-hover:text-[#0E2A47]">
                      {item.label}
                    </p>
                  </div>
                </button>
        ...
        <section id="stiefgezin-specifiek" className="scroll-mt-20 space-y-6">
        ...
        <section id="hoe-werkt-het" className="scroll-mt-20 space-y-6">
          <div className="max-w-3xl space-y-4">
            <h2 className="text-3xl lg:text-4xl font-semibold tracking-tight text-[#0E2A47]">
              Hoe werk je met het Kompasmodel?
            </h2>
...
Door bewust stil te staan bij gezinsritme en rituelen ontstaat ruimte om nieuwe vormen te ontwikkelen die recht doen aan ieders positie. Niet door alles gelijk te trekken, maar door af te stemmen en keuzes te maken die rust, duidelijkheid en erkenning bieden. Een gedragen ritme helpt om spanning te verminderen, verwachtingen te verduidelijken en het gevoel van samen gezin zijn te versterken.`}
        ...
        {/* Rest of the sections follow the same pattern... I'll include all remaining sections */}
        {/* ONDERBOUWING & BRONNEN */}
        <section id="onderbouwing" className="scroll-mt-20 space-y-6 border-t border-slate-200 pt-16">
          <div className="max-w-3xl space-y-4">
            <h2 className="text-3xl lg:text-4xl font-semibold tracking-tight text-[#0E2A47]">
              Onderbouwing & bronnen
            </h2>
        ...
        <section id="wat-niet" className="scroll-mt-20 space-y-6 border-t border-slate-200 pt-16">
          <div className="max-w-3xl space-y-4">
            <h2 className="text-3xl lg:text-4xl font-semibold tracking-tight text-[#0E2A47]">
        ...
        <section id="voor-wie" className="scroll-mt-20 space-y-6 border-t border-slate-200 pt-16">
          <div className="max-w-3xl space-y-4">
            <h2 className="text-3xl lg:text-4xl font-semibold tracking-tight text-[#0E2A47]">
        ...
        <section id="training" className="scroll-mt-20 space-y-6 border-t border-slate-200 pt-16">
          <div className="max-w-3xl space-y-4">
            <h2 className="text-3xl lg:text-4xl font-semibold tracking-tight text-[#0E2A47]">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-2xl border border-[#17B3B0]/20 bg-white p-6 shadow-sm">
              <h3 className="text-base font-semibold text-[#0E2A47] mb-2 flex items-center gap-2">
                <svg className="h-5 w-5 text-u[#17B3B0]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {showBackToTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 bg-[#17B3B0] text-white p-4 rounded-full shadow-xl hover:bg-[#0E2A47] transition-all duration-300 z-50 group"

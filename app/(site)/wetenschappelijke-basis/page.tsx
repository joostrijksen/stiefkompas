  ...
  return (
    <div className="space-y-14">
      ...
      <section className="space-y-5 border-b border-slate-200 pb-10">
        ...
        <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-[#0E2A47] max-w-3xl">
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="text-sm text-slate-600 leading-relaxed rounded-2xl border border-[#17B3B0]/15 bg-white p-5">
            <h3 className="text-xs font-semibold uppercase tracking-[0.18em] text-[#2C4B9A] mb-1">
              Kernconcepten
            </h3>
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="text-sm text-slate-600 leading-relaxed rounded-2xl border border-[#F02B8A]/15 bg-white p-5">
            <h3 className="text-xs font-semibold uppercase tracking-[0.18em] text-[#2C4B9A] mb-1">
              Relevante inzichten
            </h3>
            <ul className="list-disc pl-5 space-y-1">
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="text-sm text-slate-600 leading-relaxed rounded-2xl border border-[#2C4B9A]/15 bg-white p-5">
            <h3 className="text-xs font-semibold uppercase tracking-[0.18em] text-[#2C4B9A] mb-1">
